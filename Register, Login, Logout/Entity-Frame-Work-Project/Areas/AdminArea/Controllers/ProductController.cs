...
namespace Entity_Frame_Work_Project.Areas.AdminArea.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        //[ActionName("Edit")] ne is gorur meselem eyni adda 2 methodun olar
        //eyni method ikisdie id qebul eder onda bele deyisiklik elemey olar overloading mentiqi
        public async Task<IActionResult> Update(int id, ProductUpdateVM productUpdate)
        {
            ...
            dbProduct.Desc = productUpdate.Desc;
